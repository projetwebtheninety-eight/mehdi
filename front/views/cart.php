        ...
        <div class="ps-cart-listing">
          <div class="table-responsive">
            <table class="table ps-table ps-table--listing">
              ...
              <?php echo '<a href="javascript:window.print()">IMPRIMER VOTRE PANIER</P></a>'; ?>
                <?php
					include("E:\LOGICIELS\wamp64\www\caverne2\core\prodC.php");
					$a = new ProduitC();
          ...
          <div class="ps-cart__actions">
            ...
            <div class="ps-cart__total">
              <h3>Total Price: <span id="totalPrix"> <?php echo $a->afficherTotal();?> $</span></h3><a class="ps-btn" href="order-form.php">Process to checkout</a>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 ">
              <div class="ps-checkout__billing">
                <h3>envoyer un mail a l'admin</h3>
                    <div class="form-group form-group--inline">

                      <div class="form-group__content">
                        <input class="form-control"  type="hidden" name="mail_to"  value="mehdi.tekaya@esprit.tn" >
                      </div>
